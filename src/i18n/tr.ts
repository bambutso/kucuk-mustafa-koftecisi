...
export const tr: SiteContent = {
  ui: {
    ...
    menuPage: {
      ...
      priceOnRequest: "Fiyatı personelimizden öğrenebilirsiniz",
      servings: {
        tek: "Tek",
        duble: "Duble",
        "20cl": "20 cl",
    ...
    contact: {
      ...
      lead: "Rezervasyon ve sorularınız için bizi arayın; telefonun başında hep biri var.",
      phoneTitle: "Telefon",
      phoneNote: "Rezervasyonlar telefonla alınır.",
      addressTitle: "Adres",
      hoursTitle: "Çalışma Saatleri",
