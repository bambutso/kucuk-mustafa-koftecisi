...
export const ja: SiteContent = {
  ...
  story: {
    ...
    chapters: [
      ...
      {
        year: "現在",
        title: "師から弟子へ、世代から世代へ",
        text: "炉が放っておかれたことは、一度もありません。店は2008年に Ergin Kalınoğlu へ受け継がれ、今日はその甥、Doruk Kalınoğlu に託されています。名前は変わりました。けれど生地も、火も、戸口での迎え方も、変わりませんでした。",
      },
    ],
  },
  storyPage: {
    ...
    chapters: [
      ...
      },
      {
        id: "bugun",
        year: "現在",
        title: "Kalınoğlu 家が受け継ぐ",
        paragraphs: [
          "店は2008年に Ergin Kalınoğlu が引き継ぎました。今日はその甥、Doruk Kalınoğlu が切り盛りしています。",
          "守り手は変わっても、製法は変わりません。牛肉に、地理的表示に登録された Kıvırcık 仔羊、玉ねぎ、一日おいたパン。樫炭が灰をかぶっておき火になるまで、köfte はひとつも網にのりません。",
          "そして今も毎日、誰かが「昔、父とここへ来ていたんです」と言いながら扉をくぐります。八十年を超える労苦への、ただひとつの本当の報いは、その一言です。",
        ],
      },
    ],
    doruk: {
      title: "Doruk Kalınoğlu とは？",
      paragraphs: [
        "Doruk Kalınoğlu は、今日 Küçük Mustafa Köftecisi を切り盛りする名前です。家族から受け継いだ、深く根づいた味の伝統を、同じ心配りと丁寧さで受け継いでいます。",
        "その目指すところは、1939年から今日まで続く遺産を、変わらぬ品質とお客様のご満足を守りながら、未来へと運んでいくことです。",
      ],
    },
  },
  placePage: {
  ...
  about: {
    eyebrow: "私たちについて",
    title: "変わらない味、変わらない心配り",
    paragraphs: [
      "Küçük Mustafa Köftecisi は、変わらない味へのこだわりと高い品質基準で、お客様に常に最高の体験をお届けすることを目指しています。最初のひと口から最後のひと口まで、あらゆる細部を同じ心配りで考え抜いています。",
      "厨房で使うすべての食材は、丁寧に選び抜かれています。料理には天然のエクストラバージンオリーブオイルとひまわり油のみを使用し、パーム油などの加工油脂は一切使いません。食卓にお迎えするすべてのお客様に、最も健康的で信頼できる食材をお出しすることを信条としているからです。",
      "おいしさが続くためには、信頼が欠かせません。だからこそ、厨房では清掃と衛生の基準を最高水準で徹底し、仕込みから提供までのすべての工程を細心の注意をもって行っています。",
      "Küçük Mustafa Köftecisi が目指すのは、ただ料理を出すことではありません。上質で、信頼でき、心地よい体験をお届けすることです。",
    ],
    cards: [
      { id: "icerik", title: "自然で厳選された食材", text: "無添加で、丁寧に選んだ食材。" },
      { id: "hijyen", title: "高い衛生基準", text: "すべての工程での配慮と管理。" },
      { id: "memnuniyet", title: "お客様のご満足", text: "いつも同じ品質、同じ心配り。" },
    ],
  },
  whyUs: {
    eyebrow: "選ばれる理由",
    items: [
      { id: "yag", text: "天然エクストラバージンオリーブオイルとひまわり油のみ" },
      { id: "palm", text: "パーム油・加工油脂は不使用" },
      { id: "hijyen", text: "最高水準の衛生管理" },
